function e(e){return e&&e.__esModule?e.default:e}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},i={},s=t.parcelRequired7c6;null==s&&((s=function(e){if(e in n)return n[e].exports;if(e in i){var t=i[e];delete i[e];var s={id:e,exports:{}};return n[e]=s,t.call(s.exports,s,s.exports),s.exports}var r=new Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){i[e]=t},t.parcelRequired7c6=s),s("kyEFX").register(JSON.parse('{"5ZPII":"index.f9ab38b3.js","jcnh0":"shoping-list-bg@1x.2c75914c.png","3OouQ":"amazon@1x.17c4c4f2.png","ctt8U":"amazon@2x.225c89fa.png","1XqBp":"apple@1x.bdfd714b.png","gK52N":"apple@2x.93da152b.png","lT7aj":"book-shop@1x.926d07c4.png","ifLYX":"book-shop@2x.d7c8ffd1.png","amO9v":"empty_pic.dcf0d48a.jpg","2Hrug":"shopping-list.d91cd7a0.js"}')),s("7me8F");var r=s("7me8F"),o=s("in2tx");o=s("in2tx");function a(){!o.refs.spinner.classList.contains("done")&&o.refs.spinner.classList.add("done"),document.body.style.overflow=""}var l;function c(){const t=document.createElement("img");t.src=e(l),t.classList.add("not-found");const n=document.createElement("div");n.classList.add("warning-message");return n.innerHTML="<p> There are no data to display, please select another category.</p>",n.appendChild(t),n}function h(){const e=document.createElement("ul");e.classList.add("bookshelf__list"),o.refs.spinner.classList.contains("done")&&o.refs.spinner.classList.remove("done"),document.body.style.overflow="hidden",(0,r.getTopBooks)().then((t=>{if(!Boolean(t.length))return o.refs.mainSectionCategories.innerHTML="",o.refs.mainSectionCategories.appendChild(c());const n=t.map((({list_name:e,books:t})=>`\n          <li class='bookshelf__item'>\n            <h2 class='bookshelf__title'>${e}</h2>\n            <ul class='bookshelf__content book-card__list'>\n              ${t.map((({_id:e,book_image_height:t,book_image_width:n,author:i,book_image:s,title:r})=>`<li class='book-card__item'>\n                  <a class='book-card__link' href='#' data-id='${e}'>\n                    <div class='book-card__wrapper'>\n                      <img class='book-card__image' src='${s}' alt="Here must be book's name"\n                      width='${n}'\n                      height='${t}'>\n                      <div class='book-card__overlay'>\n                        <p class='book-card__quick-view-text'>quick view</p>\n                      </div>\n                    </div>\n                  </a>\n                  <div class='book-card__wrap'>\n                    <h3 class='book-card__name'>${r||"N/A"}</h3>\n                    <p class='book-card__author'>${i||"N/A"}</p>\n                  </div>\n                </li>`)).join("")}\n        </ul>\n            <button class='bookshelf__btn' type='button' data-see-more data-category-name='${e}'>see more</button>\n         </li>\n      `)).join("");e.innerHTML=n,o.refs.mainSectionCategories.innerHTML="<h1 class='bookcase__cda'>\n          Best Sellers <span class='bookcase__filter'>Books</span>\n        </h1>",o.refs.mainSectionCategories.appendChild(e)})).catch((e=>{console.log(e.message)})).finally(a)}l=new URL(s("kyEFX").resolve("jcnh0"),import.meta.url).toString(),s("in2tx"),h(),o.refs.logo.addEventListener("click",(()=>{h()}));o=s("in2tx"),r=s("7me8F");function d(e){let t=e.split(" ");if(1===t.length)return t;t=t[t.length-1];let n=e.split(" ");return n.pop(),`${n.join(" ")} <span class="bookcase__filter">${t}</span>`}o=s("in2tx");function u(e){e.preventDefault();const t=e.target.dataset.categoryName;if(!t)return;document.querySelector(".categories__active").classList.remove("categories__active");document.querySelector(`[data-category-name="${t}"]`).classList.add("categories__active"),function(e,t="start"){e.scrollIntoView({behavior:"smooth",position:t})}(o.refs.sectionCategory);let n=document.createElement("h1");const i=document.createElement("ul");n.classList.add("bookcase__cda"),n.innerHTML=d(t),i.classList.add("bookshelf__content","book-card__list"),"All categories"!==t?(0,r.getBooksByCategory)(t).then((e=>{if(!Boolean(e.length))return o.refs.mainSectionCategories.innerHTML="",o.refs.mainSectionCategories.appendChild(c());const t=e.map((({book_image:e,book_image_height:t,book_image_width:n,author:i,title:s,buy_links:r,_id:o})=>`<li class='book-card__item'>\n  <a class='book-card__link' href='#' data-id='${o}'>\n    <div class='book-card__wrapper'>\n      <img\n        class='book-card__image'\n        src='${e}'\n        alt="Here must be book's name"\n        width='${n}'\n        height = '${t}'\n      />\n      <div class='book-card__overlay'>\n        <p class='book-card__quick-view-text'>quick view</p>\n      </div>\n    </div>\n  </a>\n  <div class='book-card__wrap'>\n    <h3 class='book-card__name'>${s||"N/A"}</h3>\n    <p class='book-card__author'>${i||"N/A"}</p>\n  </div>\n</li>`)).join("");i.innerHTML=t,o.refs.sectionCategory.innerHTML="",o.refs.sectionCategory.appendChild(n),o.refs.sectionCategory.appendChild(i)})).catch((e=>console.log(e.message))):h()}(0,r.getCategoryList)().then((e=>{const t=e.map((e=>`\n        <li class = 'categories__item'>\n          <button type="button" data-category-name='${e}' class='categories__name'>${e}</button>\n        </li>`)).join("");o.refs.categoriesList.innerHTML="\n       <li class='categories__item categories__item--fixed'>\n          <button type=\"button\" class='categories__name categories__active' data-category-name='All categories'>All categories</button>\n       </li>",o.refs.categoriesList.insertAdjacentHTML("beforeend",t)})).catch((e=>console.log(e.message))),o.refs.categoriesList.addEventListener("click",u),o.refs.mainSectionCategories.addEventListener("click",u),s("eHzQI"),s("dTazW"),s("8QtOa"),s("fn969"),s("4GINZ");o=s("in2tx");var p=s("ix4Jr"),g=s("4a6xH"),f=s("7vF8m"),m=s("ffjl9");
/**
 * @license
 ...
 * limitations under the License.
 */
class S{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class R{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable((()=>t(_.UNAUTHENTICATED)))}shutdown(){}}class A{constructor(e){this.auth=null,e.onInit((e=>{this.auth=e}))}getToken(){return this.auth?this.auth.getToken().then((e=>e?(L("string"==typeof e.accessToken),new S(e.accessToken,new _(this.auth.getUid()))):null)):Promise.resolve(null)}invalidateToken(){}start(e,t){}shutdown(){}}class I{constructor(e,t,n){this.t=e,this.i=t,this.o=n,this.type="FirstParty",this.user=_.FIRST_PARTY,this.u=new Map}h(){return this.o?this.o():null}get headers(){this.u.set("X-Goog-AuthUser",this.t);const e=this.h();return e&&this.u.set("Authorization",e),this.i&&this.u.set("X-Goog-Iam-Authorization-Token",this.i),this.u}}class N{constructor(e,t,n){this.t=e,this.i=t,this.o=n}getToken(){return Promise.resolve(new I(this.t,this.i,this.o))}start(e,t){e.enqueueRetryable((()=>t(_.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class D{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class F{constructor(e){this.l=e,this.appCheck=null,e.onInit((e=>{this.appCheck=e}))}getToken(){return this.appCheck?this.appCheck.getToken().then((e=>e?(L("string"==typeof e.token),new D(e.token)):null)):Promise.resolve(null)}invalidateToken(){}start(e,t){}shutdown(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *

 ...
 */
var R="9.19.0",S=new(0,L.Logger)("@firebase/firestore");
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N(t){for(var n=arguments.length,i=new Array(n>1?n-1:0),o=1;o<n;o++)i[o-1]=arguments[o];if(S.logLevel<=L.LogLevel.DEBUG){var r,s=i.map(C);(r=S).debug.apply(r,["Firestore (".concat(R,"): ").concat(t)].concat(e(_)(s)))}}function I(t){for(var n=arguments.length,i=new Array(n>1?n-1:0),o=1;o<n;o++)i[o-1]=arguments[o];if(S.logLevel<=L.LogLevel.ERROR){var r,s=i.map(C);(r=S).error.apply(r,["Firestore (".concat(R,"): ").concat(t)].concat(e(_)(s)))}}function C(e){if("string"==typeof e)return e;try{return t=e,JSON.stringify(t)}catch(t){return e}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"Unexpected state",t="FIRESTORE (".concat(R,") INTERNAL ASSERTION FAILED: ")+e;throw I(t),new Error(t)}function B(e,t){e||D()}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var x="invalid-argument",O="failed-precondition",H=function(t){"use strict";e(k)(i,t);var n=e(b)(i);function i(t,o){var r;return e(g)(this,i),(r=n.call(this,t,o)).code=t,r.message=o,r.toString=function(){return"".concat(r.name,": [code=").concat(r.code,"]: ").concat(r.message)},e(y)(r)}return i}(T.FirebaseError),U=function t(n,i){"use strict";e(g)(this,t),this.user=i,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization","Bearer ".concat(n))},F=function(){"use strict";function t(){e(g)(this,t)}return e(v)(t,[{key:"getToken",value:function(){return Promise.resolve(null)}},{key:"invalidateToken",value:function(){}},{key:"start",value:function(e,t){e.enqueueRetryable((function(){return t(A.UNAUTHENTICATED)}))}},{key:"shutdown",value:function(){}}]),t}(),M=function(){"use strict";function t(n){var i=this;e(g)(this,t),this.auth=null,n.onInit((function(e){i.auth=e}))}return e(v)(t,[{key:"getToken",value:function(){var e=this;return this.auth?this.auth.getToken().then((function(t){return t?(B("string"==typeof t.accessToken),new U(t.accessToken,new A(e.auth.getUid()))):null})):Promise.resolve(null)}},{key:"invalidateToken",value:function(){}},{key:"start",value:function(e,t){}},{key:"shutdown",value:function(){}}]),t}(),P=function(){"use strict";function t(n,i,o){e(g)(this,t),this.t=n,this.i=i,this.o=o,this.type="FirstParty",this.user=A.FIRST_PARTY,this.u=new Map}return e(v)(t,[{key:"h",value:function(){return this.o?this.o():null}},{key:"headers",get:function(){this.u.set("X-Goog-AuthUser",this.t);var e=this.h();return e&&this.u.set("Authorization",e),this.i&&this.u.set("X-Goog-Iam-Authorization-Token",this.i),this.u}}]),t}(),z=function(){"use strict";function t(n,i,o){e(g)(this,t),this.t=n,this.i=i,this.o=o}return e(v)(t,[{key:"getToken",value:function(){return Promise.resolve(new P(this.t,this.i,this.o))}},{key:"start",value:function(e,t){e.enqueueRetryable((function(){return t(A.FIRST_PARTY)}))}},{key:"shutdown",value:function(){}},{key:"invalidateToken",value:function(){}}]),t}(),q=function t(n){"use strict";e(g)(this,t),this.value=n,this.type="AppCheck",this.headers=new Map,n&&n.length>0&&this.headers.set("x-firebase-appcheck",this.value)},V=function(){"use strict";function t(n){var i=this;e(g)(this,t),this.l=n,this.appCheck=null,n.onInit((function(e){i.appCheck=e}))}return e(v)(t,[{key:"getToken",value:function(){return this.appCheck?this.appCheck.getToken().then((function(e){return e?(B("string"==typeof e.token),new q(e.token)):null})):Promise.resolve(null)}},{key:"invalidateToken",value:function(){}},{key:"start",value:function(e,t){}},{key:"shutdown",value:function(){}}]),t}(),j=function(){"use strict";function t(n,i){e(g)(this,t),this.projectId=n,this.database=i||"(default)"}return e(v)(t,[{key:"isDefaultDatabase",get:function(){return"(default)"===this.database}},{key:"isEqual",value:function(e){return e instanceof t&&e.projectId===this.projectId&&e.database===this.database}}],[{key:"empty",value:function(){return new t("","")}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *

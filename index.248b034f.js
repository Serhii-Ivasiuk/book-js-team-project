 ...
 */
var w="9.19.0",L=new(0,b.Logger)("@firebase/firestore");
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function R(t){for(var n=arguments.length,i=new Array(n>1?n-1:0),o=1;o<n;o++)i[o-1]=arguments[o];if(L.logLevel<=b.LogLevel.DEBUG){var r,s=i.map(S);(r=L).debug.apply(r,["Firestore (".concat(w,"): ").concat(t)].concat(e(v)(s)))}}function A(t){for(var n=arguments.length,i=new Array(n>1?n-1:0),o=1;o<n;o++)i[o-1]=arguments[o];if(L.logLevel<=b.LogLevel.ERROR){var r,s=i.map(S);(r=L).error.apply(r,["Firestore (".concat(w,"): ").concat(t)].concat(e(v)(s)))}}function S(e){if("string"==typeof e)return e;try{return t=e,JSON.stringify(t)}catch(t){return e}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"Unexpected state",t="FIRESTORE (".concat(w,") INTERNAL ASSERTION FAILED: ")+e;throw A(t),new Error(t)}function D(e,t){e||I()}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Q="".concat(_.SDK_VERSION,"_lite"),w=Q,(0,_._registerComponent)(new(0,m.Component)("firestore/lite",(function(e,t){var n=t.instanceIdentifier,i=t.options,o=e.getProvider("app").getImmediate(),r=new Z(new U(e.getProvider("auth-internal")),new P(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new x(N,'"projectId" not provided in firebase.initializeApp.');return new z(e.options.projectId,t)}(o,n),o);return i&&r._setSettings(i),r}),"PUBLIC").setMultipleInstances(!0)),(0,_.registerVersion)("firestore-lite","3.10.0",""),(0,_.registerVersion)("firestore-lite","3.10.0","esm2017");r=o("1h2Gi"),s=o("kVdBw");function $(e){e.currentTarget===e.target&&te()}function ee(e){"Escape"===e.key&&te()}function te(){s.refs.popupBackdrop.classList.add("is-hidden"),s.refs.popupCloseBtn.removeEventListener("click",te),s.refs.popupBackdrop.removeEventListener("click",$),s.refs.addToLocalBtn.removeEventListener("click",ge),window.removeEventListener("keydown",ee),document.body.style.overflow=""}var ne;ne=o("aNJCr").getBundleURL("EVgbq")+o("iE7OH").resolve("6ztcb");var ie;ie=o("aNJCr").getBundleURL("EVgbq")+o("iE7OH").resolve("1iaLI");var oe;oe=o("aNJCr").getBundleURL("EVgbq")+o("iE7OH").resolve("f8I3T");var re;re=o("aNJCr").getBundleURL("EVgbq")+o("iE7OH").resolve("3ZLqn");var se;se=o("aNJCr").getBundleURL("EVgbq")+o("iE7OH").resolve("9Cr2S");var ae;ae=o("aNJCr").getBundleURL("EVgbq")+o("iE7OH").resolve("8Aq8R");var ce,le=document.querySelector(".bookcase"),ue=[],he=[],de=[];function fe(){return(fe=e(u)(e(h).mark((function t(n){var i,o,a;return e(h).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(n.preventDefault(),n.target.closest(".book-card__link")){e.next=3;break}return e.abrupt("return");case 3:return ve(),i=n.target.closest(".book-card__link").dataset.id,de=i,e.next=8,(0,r.getBookDetail)(i);case 8:o=e.sent,a=pe(o),de={bookId:i,bookData:o},s.refs.popupCardContainer.innerHTML=a,he.forEach((function(e){ue.push(e.bookId)})),ue.includes(de.bookId)?(s.refs.addToLocalBtn.innerHTML="remove from the shopping list",s.refs.popupDesc.style.opacity="1"):(s.refs.addToLocalBtn.innerHTML="add to shopping list",s.refs.popupDesc.style.opacity="0"),o.buy_links,document.body.style.overflow="hidden",s.refs.popupBackdrop.classList.remove("is-hidden"),s.refs.popupCloseBtn.addEventListener("click",te),s.refs.popupBackdrop.addEventListener("click",$),s.refs.addToLocalBtn.addEventListener("click",ge),window.addEventListener("keydown",ee);case 21:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function pe(t){var n=t.title,i=t.author,o=t.book_image_height,r=t.book_image_width,s=t.book_image,a=t.description,c=t.buy_links;a||(a="N/A"),i||(i="N/A"),n||(n="N/A");var l="",u="",h="";return c.forEach((function(e){"Amazon"===e.name&&(l=e.url),"Apple Books"===e.name&&(u=e.url),"Bookshop"===e.name&&(h=e.url)})),'<div class="pop-up__block-img"> <img\n      class="pop-up__img "\n      src='.concat(s,"\n      alt='").concat(n,"'\n      width=").concat(r,"\n      heigth=").concat(o,'\n    />\n    </div>\n    <div class="pop-up__book-info">\n      <h2 class="card__book-name ">').concat(n,'</h2>\n      <h3 class="card__book-author ">').concat(i,'</h3>\n      <p class="card__book-text ">\n        ').concat(a,'\n      </p>\n      <div class="book-shop__thumb">\n        <a href="').concat(l,'" class="book-shop__link" target="_blank">\n          <picture>\n            <source\n              srcset="\n                ').concat(e(ne),",\n                ").concat(e(ie),'\n              "\n            />\n            <img\n              class="book-shop__img"\n              src="').concat(e(ne),'"\n              alt="amazon"\n              width="48"\n            />\n          </picture>\n        </a>\n        <a href="').concat(u,'" class="book-shop__link" target="_blank"\n          ><picture>\n            <source\n              srcset="\n                ').concat(e(oe),",\n                ").concat(e(re),'\n              "\n            />\n            <img\n              class="book-shop__img"\n              src="').concat(e(oe),'"\n              alt="apple"\n              width="28"\n            /> </picture\n        ></a>\n        <a href="').concat(h,'" class="book-shop__link" target="_blank"\n          ><picture>\n            <source\n              srcset="\n                ').concat(e(se),",\n                ").concat(e(ae),'\n              "\n            />\n            <img\n              class="book-shop__img"\n              src="').concat(e(se),'"\n              alt="book-shop"\n              width="32"\n            /> </picture\n        ></a>\n      </div>\n    </div>')}function ge(){he.some((function(e){return e.bookId===de.bookId}))?(he=he.filter((function(e){return e.bookId!==de.bookId})),s.refs.addToLocalBtn.innerHTML="add to shopping list",s.refs.popupDesc.style.opacity="0",ve()):(he.push(de),s.refs.addToLocalBtn.innerHTML="remove from the shopping list",s.refs.popupDesc.style.opacity="1",ve())}function ve(){localStorage.setItem("books-id",JSON.stringify(he)),ue=[]}null===localStorage.getItem("books-id")?localStorage.setItem("books-id",JSON.stringify([])):(ce=localStorage.getItem("books-id"),he=JSON.parse(ce)),le.addEventListener("click",(function(e){return fe.apply(this,arguments)})),o("8zUhP"),o("8e9SS");s=o("kVdBw");window.addEventListener("scroll",(function(){var e=s.refs.sidebar.offsetHeight,t=s.refs.content.offsetHeight,n=window.pageYOffset||document.documentElement.scrollTop;0===n&&(s.refs.sidebar.scrollTop=0),n+window.innerHeight>=t&&(s.refs.sidebar.scrollTop=e-window.innerHeight+t-n)}))}();
//# sourceMappingURL=index.248b034f.js.map
